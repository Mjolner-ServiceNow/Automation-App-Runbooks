...
.DESCRIPTION
    This runbook starts an Azure virtual machine in the specified resource group.
...
try {
    ...
    $OperationResult = Start-AzVM -Name $VMName -ResourceGroupName $ResourceGroupName -ErrorAction Stop
