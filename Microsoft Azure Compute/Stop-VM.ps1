...
.DESCRIPTION
    This runbook stops an Azure virtual machine in the specified resource group.
...
.EXAMPLE
    .\Stop-VM.ps1 -SubscriptionId "xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx" -VMName "MyVM" -ResourceGroupName "MyResourceGroup"
...
try {
    ...
    $OperationResult = Stop-AzVM -Name $VMName -ResourceGroupName $ResourceGroupName -Force -ErrorAction Stop

    Write-Verbose "Virtual machine stopped successfully"
}
catch {
